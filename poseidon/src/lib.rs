...
mod tests {
    ...
    fn test_hash_two_basic() {
        ...
        let input1 = Fr::from_u256(U256::from_u32(&env, 123));
        let input2 = Fr::from_u256(U256::from_u32(&env, 456));
    ...
    fn test_hash_two_different_inputs() {
        ...
        let input1 = Fr::from_u256(U256::from_u32(&env, 123));
        let input2 = Fr::from_u256(U256::from_u32(&env, 456));
        let input3 = Fr::from_u256(U256::from_u32(&env, 789));

        let result1 = poseidon.hash_two(&env, &input1, &input2);
        let result2 = poseidon.hash_two(&env, &input1, &input3);

        std::println!("{:?}", result1.to_bytes());
        std::println!("{:?}", result2.to_bytes());

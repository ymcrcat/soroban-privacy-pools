#![no_std]
use soroban_sdk::{contract, contractimpl, vec, Env, String, Vec, Address, symbol_short, Symbol, Bytes, BytesN};
...
impl Contract {
    ...
    pub fn withdraw(env: Env, to: Address, nullifier: BytesN<32>, __proof: Bytes) -> Vec<String> {
        to.require_auth();
